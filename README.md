...
However the sale prices (as well as gifts & subscription service) came to a total of €10,196.69.  
This resulted in savings of €12,596.98 (55.26% of the total full price).  
The above results also display the number of video games purchased each year, which can then show the average prices per year:  
